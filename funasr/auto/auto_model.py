...
class AutoModel:
    ...
    def build_model(self, **kwargs):
        ...
        # #save
        # if kwargs["model"] == "BiCifParaformer":
        #     torch.save(model.predictor.cif_conv1d.weight, "bmodel/asr_bicif/cif_conv1d_weight.pt")
        #     torch.save(model.predictor.cif_conv1d.bias, "bmodel/asr_bicif/cif_conv1d_bias.pt")

        #     torch.save(model.predictor.cif_output.weight, "bmodel/asr_bicif/cif_output_weight.pt")
        #     torch.save(model.predictor.cif_output.bias, "bmodel/asr_bicif/cif_output_bias.pt")

        #     torch.save(model.predictor.upsample_cnn.weight, "bmodel/asr_bicif/upsample_cnn_weight.pt")
        #     torch.save(model.predictor.upsample_cnn.bias, "bmodel/asr_bicif/upsample_cnn_bias.pt")

        #     torch.save(model.predictor.blstm._parameters["weight_ih_l0"], "bmodel/asr_bicif/weight_ih_l0.pt")
        #     torch.save(model.predictor.blstm._parameters["weight_hh_l0"], "bmodel/asr_bicif/weight_hh_l0.pt")
        #     torch.save(model.predictor.blstm._parameters["bias_ih_l0"], "bmodel/asr_bicif/bias_ih_l0.pt")
        #     torch.save(model.predictor.blstm._parameters["bias_hh_l0"], "bmodel/asr_bicif/bias_hh_l0.pt")
        #     torch.save(model.predictor.blstm._parameters["weight_ih_l0_reverse"], "bmodel/asr_bicif/weight_ih_l0_reverse.pt")
        #     torch.save(model.predictor.blstm._parameters["weight_hh_l0_reverse"], "bmodel/asr_bicif/weight_hh_l0_reverse.pt")
        #     torch.save(model.predictor.blstm._parameters["bias_ih_l0_reverse"], "bmodel/asr_bicif/bias_ih_l0_reverse.pt")
        #     torch.save(model.predictor.blstm._parameters["bias_hh_l0_reverse"], "bmodel/asr_bicif/bias_hh_l0_reverse.pt")

        #     torch.save(model.predictor.cif_output2.weight, "bmodel/asr_bicif/cif_output2_weight.pt")
        #     torch.save(model.predictor.cif_output2.bias, "bmodel/asr_bicif/cif_output2_bias.pt")
